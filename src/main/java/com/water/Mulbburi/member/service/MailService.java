...
public class MailService implements MailServiceInter {
	...
	public MimeMessage createMessage(String to) throws MessagingException, UnsupportedEncodingException {
		...
		message.setSubject("물뿌리개 비밀번호 찾기 이메일 인증");
		
		String msgg = "";
		msgg += "<div style='margint:100px;'>";
		msgg += "<h1> 안녕하세요</h1>";
		msgg += "<h1> 식물종합쇼핑몰 물뿌리개 입니다</h1>";
		msgg += "<br>";
		msgg += "<p>아래 코드를 비밀번호 찾기 창으로 돌아가 입력해주세요<p>";
		msgg += "<br>";
		msgg += "<p>즐거운 쇼핑되시고 감사합니다!<p>";
		msgg += "<br>";
		...
		message.setFrom(new InternetAddress("tkdduq717@naver.com", "Admin"));// 보내는 사람
