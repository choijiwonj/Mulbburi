...
public class CommunityController {
	...
	public String selectcommunityDetail(@RequestParam Long no, Model model) {
		...
		log.info("[BoardController] communityDetail : {}", communityDetail);
	...
	/* 게시글 등록 컨트롤러 핸들러 메소드 */
	@PostMapping("/regist")
	public String registBoard(CommunityDTO community, @AuthenticationPrincipal MemberDTO member,
			RedirectAttributes rttr) {
		
		community.setMemberNo(member);
		...
		return "redirect:/community/comWrite";
	}
